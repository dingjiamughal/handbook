(function (t, e) {
    if ('object' === typeof exports && 'object' === typeof module)
        module.exports = e(require('vue-router'), require('vue'));
    else if ('function' === typeof define && define.amd) define(['vue-router', 'vue'], e);
    else {
        var n = 'object' === typeof exports ? e(require('vue-router'), require('vue')) : e(t['vue-router'], t['vue']);
    ...
    return (function (t) {
        ...
        '56d7': function (t, e, n) {
            ...
            var l = d(p, a, f, !1, null, null, null),
                ...
                k = new u.a({mode: 'history', routes: N});
            i.a.use(u.a),
